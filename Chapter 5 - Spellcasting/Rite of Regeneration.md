...
*Rolling a 1*: When a 1 is rolled on the d20, the Regeneration check automatically fails and the target receives one level of Exhaustion in addition to taking the consequences above.
