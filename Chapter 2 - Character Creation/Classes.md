...
**_Battle Master - Parry_**: When [[Parrying]], you can expend one Superiority Die, rolling the die and adding the number rolled to the Parrying check. If the parry succeeds, you increase the Parrying Power by the maximum roll of your Superiority Die.
