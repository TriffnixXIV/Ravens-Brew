...
**_Spell Check_**: When you cast a spell, you roll a D20 Test and add your spellcasting ability modifier. If you aren't using a [[Spellcasting Focus]] that is associated with the school of the spell to cast the spell, the spell is unfocused, making you roll with Disadvantage.
...
Florb was not satisfied with that singular attack and casts _Scorching Ray_ in the next round. They roll an 11 on their first Spell check and thus the first spell attack, a 7 on their second one, and a 16 on their third one. Their Medium-sized target with a Hit DC of 10 is thus hit twice. Each of these attacks would have to be counterspelled separately.

Due to the undesired attention they drew to themselves, Florb has to use _Greater Invisibility_. As their Staff does not focus Illusion spells, they have to roll their Spell check with Disadvantage, rolling a 4, for a total of 8, making this spellcast quite simple to counterspell.