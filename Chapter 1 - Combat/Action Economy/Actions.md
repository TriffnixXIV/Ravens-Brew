...
_Escaping a Grapple_: A grappled creature can use its action to escape. To do so, it must succeed on a Strength (Athletics) or Dexterity (Acrobatics) check contested by your Strength (Athletics) check. The grapple also ends if you have the Incapacitated condition or if the distance between you and the Grappled target exceeds your reach.
