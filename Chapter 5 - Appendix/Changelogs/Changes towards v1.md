...
- added _Improvised Weapon Training_ and _Improviser_ to offer ways to receive Training with improvised weapons and add the Proficiency Bonus to attacks made with them.
- renamed _Reactive Strike_ to _Gatekeeper_.
- changed _Great Weapon Fighting_ to be mechanically aligned with _Savage Attacker_.
- changed _Heavy Weapon Master_ to not be limited to the Attack action.
- changed _Thrown Weapon Fighting_ to give bonus damage equal to the Strength modifier.
- removed _Unarmed Fighting_ to have the damage buff as a standalone feature in _Boxer_ and have the grappling damage in _Wrestler_.
- added _Wrestler_ for better Grappling offence.
- added _Punch and Grab_ for better Grappling utility.
- clarified _Immaculate Aim_.
- changed _Happy Feet_ to use the Dexterity modifier instead.
- clarified _Areal Awareness_.
- added _Shield Fighting_.
- changed _Arrow Splitting_ and _Interception_ to use your reach instead of a fixed 5 foot distance.
- renamed _Elegant Parry_ to _Intuitive Parry_.
- renamed _Vengeful Parry_ to _Tit for Tat_.
...
- changed _By Any Means_ to only be usable on a failure and until success.
- increased _Everyone's Problem_ range to 10 feet.
- changed _Limitbreaker_ to be usable more frequently.
...
- removed the Pact Magic Table from the Warlock section. Now references the Pact Magic Table in the appendix twice to make up for it.
